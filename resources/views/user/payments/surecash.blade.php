                    ...
                    <div class="col-lg-6">
                        <div class="pay__with-container --2">
                            <div class="pay__with-box">
                                <h1 class="payment__title">Pay with surecash</h1>
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        <div class="img__bx">
                                            <img src="{{asset('payment/assets/img/sureCash.png')}}" alt="surecash" />
                                        </div>
                                        <h4 class="way__name">surecash Personal</h4>
                                        <h4 class="account__num">017560637294</h4>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="qr__box">
