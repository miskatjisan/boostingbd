...
<section class="payment__section" style="margin-top:120px">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="pay__with-container">
                            <div class="pay__with-box">
                                <h1 class="payment__title">Pay with bKash</h1>
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        <div class="img__bx">
                                            <img src="{{asset('payment/assets/img/bkash.png')}}" alt="bKash" />
                                        </div>
                                        <h4 class="way__name">Bkash merchant</h4>
                                        <h4 class="account__num">01749935515</h4>
                                        <h4 class="way__name">Bkash personal</h4>
                                        <h4 class="account__num">01756063729</h4>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="qr__box">
